...
if HOSTNAME == "oai-alethea":
    IMAGE_DIR = "/Users/alethea/data/grok/output/images"
    DATA_DIR = f"/Users/alethea/data/rcall/gce/grok"
else:
    IMAGE_DIR = "/mnt/lustre/openai/alethea/images/grok"
    DATA_DIR = f"/mnt/lustre/openai/alethea/logs/grok"
